...
public enum TeamEnum {
    ...
    YELLOW("Jaune", ChatColor.YELLOW + "⬤ ", new ItemBuilder(Material.BANNER).setData((byte) 11).setName(ChatColor.YELLOW + "Jaune").setLore(ChatColor.GRAY + "- " + ChatColor.ITALIC + "vide", ChatColor.GRAY + "- " + ChatColor.ITALIC + "vide").build()),
    ...
    BLUE("Bleu", ChatColor.BLUE + "⬤ ", new ItemBuilder(Material.BANNER).setData((byte) 4).setName(ChatColor.BLUE + "Bleu").setLore(ChatColor.GRAY + "- " + ChatColor.ITALIC + "vide", ChatColor.GRAY + "- " + ChatColor.ITALIC + "vide").build()),
